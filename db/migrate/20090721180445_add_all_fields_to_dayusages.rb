class AddAllFieldsToDayusages < ActiveRecord::Migration
  def self.up
	...
	add_column :dayusages, :total_phymem, :float, :default => 0.0
	add_column :dayusages, :max_phymem, :float, :default => 0.0

	add_column :dayusages, :avg_virmem, :float, :default => 0.0
	add_column :dayusages, :total_virmem, :float, :default => 0.0
	add_column :dayusages, :max_virmem, :float, :default => 0.0

	add_column :dayusages, :avg_procs, :integer, :default => 0
	add_column :dayusages, :total_procs, :integer, :default => 0
	add_column :dayusages, :max_procs, :integer, :default => 0

	add_column :dayusages, :avg_runprocs, :integer, :default => 0
